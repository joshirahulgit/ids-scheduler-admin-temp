...
@Component({
    selector: 'authorization-user-statuses',
    templateUrl: 'authorization-user-statuses.component.html'
})
export class AuthorizationUserStatusesComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        // this._routeSubscription = this._route.params.subscribe(params => {
            this.group = "AuthorizationUserStatuses";//params['group'];
